	...
	<tr>
		<td>
			<a href="https://GitHub.Com/CodeEditorLand/Air" target="_blank">
				<picture>
					<source media="(prefers-color-scheme: dark)" srcset="https://img.shields.io/github/last-commit/CodeEditorLand/Air?label=Update&color=black&labelColor=black&logoColor=white&logoWidth=0" />
					<source media="(prefers-color-scheme: light)" srcset="https://img.shields.io/github/last-commit/CodeEditorLand/Air?label=Update&color=white&labelColor=white&logoColor=black&logoWidth=0" />
					<img src="https://img.shields.io/github/last-commit/CodeEditorLand/Air?label=Update&color=black&labelColor=black&logoColor=white&logoWidth=0" alt="Update" title="Update" />
				</picture>
			</a>
			<br />
			<a href="https://GitHub.Com/CodeEditorLand/Air" target="_blank">
				<picture>
					<source media="(prefers-color-scheme: dark)" srcset="https://img.shields.io/github/issues/CodeEditorLand/Air?label=Issue&color=black&labelColor=black&logoColor=white&logoWidth=0" />
					<source media="(prefers-color-scheme: light)" srcset="https://img.shields.io/github/issues/CodeEditorLand/Air?label=Issue&color=white&labelColor=white&logoColor=black&logoWidth=0" />
					<img src="https://img.shields.io/github/issues/CodeEditorLand/Air?label=Issue&color=black&labelColor=black&logoColor=white&logoWidth=0" alt="Issue" title="Issue" />
				</picture>
			</a>
		</td>
		<td>
			...
			<a href="https://GitHub.Com/CodeEditorLand/Air" target="_blank">
				<picture>
					<source media="(prefers-color-scheme: dark)" srcset="https://img.shields.io/github/downloads/CodeEditorLand/Air/total?label=Download&color=black&labelColor=black&logoColor=white&logoWidth=0" />
					<source media="(prefers-color-scheme: light)" srcset="https://img.shields.io/github/downloads/CodeEditorLand/Air/total?label=Download&color=white&labelColor=white&logoColor=black&logoWidth=0" />
					<img src="https://img.shields.io/github/downloads/CodeEditorLand/Air/total?label=Download&color=black&labelColor=black&logoColor=white&logoWidth=0" alt="Download" title="Download" />
				</picture>
			</a>
		</td>
	</tr>
...
capabilities of the **Land** Code Editor. While
**Mountain**&#x2001;⛰️ handles the core application logic and UI, **Air**
operates as a specialized sidecar process dedicated to heavy lifting, network
operations, and system maintenance. It ensures that the main editor remains
responsive by offloading resource-intensive tasks such as updates, large
downloads, cryptographic signing, and file indexing.
...
**Air**&#x2001;🪁 is the persistent background daemon for the Land
ecosystem. It communicates with **Mountain**&#x2001;⛰️ via
**Vine**&#x2001;🌿 (`gRPC`) on port `[::1]:50053` and uses
**Mist**&#x2001;🌫️ for DNS isolation on its HTTP client.
...
2. **Connect:** **Mountain**&#x2001;⛰️ establishes a
   **Vine**&#x2001;🌿 (`gRPC`) connection to **Air**&#x2001;🪁's local
   port `[::1]:50053`.
3. **Delegate:** When a user requests an update or large download,
   **Mountain**&#x2001;⛰️ sends a command to **Air**&#x2001;🪁 and
   immediately returns control to the user.
4. **Monitor:** **Air**&#x2001;🪁 emits progress events back to
   **Mountain**&#x2001;⛰️ to update the UI status bars.
...
see the [`LICENSE`](https://github.com/CodeEditorLand/Air/tree/Current/LICENSE)
file.
...
See
[`CHANGELOG.md`](https://github.com/CodeEditorLand/Air/tree/Current/CHANGELOG.md)
for a history of changes specific to **Air**&#x2001;🪁.
