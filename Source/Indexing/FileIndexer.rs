...
use crate::{
	...
	Indexing::{
		IndexResult::{IndexResult, IndexStatistics},
		Scan::{
			ScanDirectory::{ScanAndRemoveDeleted, ScanDirectoriesParallel},
			ScanFile::IndexFileInternal,
		},
		State::{
			CreateState::{CreateNewIndex, FileIndex, FileMetadata, SymbolInfo, SymbolLocation},
			UpdateState::{UpdateIndexMetadata, ValidateIndexConsistency},
		},
		Store::{
...
pub struct FileIndexer {
	/// Application state
	pub AppState:Arc<crate::ApplicationState::ApplicationState::Struct>,
